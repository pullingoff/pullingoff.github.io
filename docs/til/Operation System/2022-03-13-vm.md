...
![메모리에 없는 페이지의 페이지 테이블](/images/blog/cs//vm1.png)
...
![페이지 폴트의 순서](/images/blog/cs//vm2.png)
![페이지 폴트 대처법](/images/blog/cs//vm3.png)
...
![옵티멀 알고리즘](/images/blog/cs//vm4.png)
...
![FIFO 알고리즘](/images/blog/cs//vm5.png)

- 이 알고리즘의 나쁜 성질: 메모리 프레임 크기를 늘리면 성능이 더 나빠짐 (FIFO Anomaly라고 부름)

### LRU(Least Recently Used) Algorithm

![LRU Algorithm ](/images/blog/cs//vm6.png)
![LRU Algorithm 구현법](/images/blog/cs//vm8.png)
...
![LFU 리스트로 구현](/images/blog/cs//vm9.png)
![LFU 힙으로 구현](/images/blog/cs//vm10.png)
...
![LRU, LFU 알고리즘 예제](/images/blog/cs//vm7.png)
...
![클락 알고리즘](/images/blog/cs//vm11.png)
![클락 알고리즘의 시계모양 예시](/images/blog/cs//vm12.png)
...
![페이지 프레임 할당](/images/blog/cs//vm13.png)
...
![thrashing diagram](/images/blog/cs//vm14.png)
...
![working set model](/images/blog/cs//vm15.png)
![워킹 셋 결정하는 법](/images/blog/cs//vm17.png)
...
![워킹 셋 결정하는 법](/images/blog/cs//vm16.png)
...
![워킹 셋 결정하는 법](/images/blog/cs//vm18.png)
